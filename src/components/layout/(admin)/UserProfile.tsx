			...
			{userState?.user ? (
				<DropdownMenu>
					...
					>
						...
						<span
							className={`${inSideNav ? 'inline-block' : 'hidden'} lg:inline`}
						>
							{inSideNav ? (
					...
					<DropdownMenuContent>
						...
						<DropdownMenuItem className="cursor-pointer">
							<Link
								href={routes.ADMIN.SETTINGS.MYACCOUNT_PROFILE}
						...
						<DropdownMenuItem className="cursor-pointer">
							<Link
								href={routes.ADMIN.SETTINGS.SUBSCRIPTION}
								className="flex items-center gap-2 w-full text-gray-800 font-medium rounded-md"
							>
